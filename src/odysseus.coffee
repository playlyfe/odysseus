((root, factory) ->
  ...
  class Odysseus
    ...
    @stored_templates: {
      ...
      ###
      "create": {
        text: "{{od.ctx.amActor ? 'You' : od.story.actor.alias||od.story.actor.id}} created "+
      ...
      "delete": {
        text: "{{od.ctx.amActor ? 'You' : od.story.actor.alias||od.story.actor.id}} deleted "+
              "the {{od.ctx.isTeam ? 'team' : 'process'}} "+
              "'{{od.story.team ? od.story.team.name || od.story.team.id :"+
                "od.story.process.name || od.story.process.id}}'.\n"+
              "[{{moment(od.story.timestamp).format('llll')}}]",
      ...
      "join": {
        text: "{{od.ctx.amActor ? 'You' : od.story.actor.alias||od.story.actor.id}} joined "+
        ...
        image: """
                ...
                ${ } else { }$\
                  <img \
                    src='{{od.ext.base_url}}/{{od.ctx.amActor ? od.ext.profile.id : od.story.actor.id}}' \
                    alt='{{od.ctx.amActor ? od.ext.profile.alias : od.story.actor.alias}}'>\
                ${ } }$
               """
      },
      "leave": {
        text: "{{od.ctx.amActor ? 'You' : od.story.actor.alias||od.story.actor.id}} left "+
              "{{od.ctx.isItem ? 'this' : 'the'}} {{od.ctx.isTeam ? 'team' : 'process'}}"+
              "${ if (!od.ctx.isItem) { }$"+
                " '{{od.story.team ? od.story.team.name || od.story.team.id :"+
                  "od.story.process.name || od.story.process.id}}'"+
      ...
      "kick": {
        text: "{{od.ctx.amActor ? 'You' : od.story.actor.alias||od.story.actor.id}} kicked "+
      ...
      "join:request:accept": {
        text: "{{od.ctx.amPlayer ? 'Your' : (od.story.player.alias||od.story.player.id) + '\u2019s'}} "+
              "request to join "+
              "{{od.ctx.isItem ? 'this' : 'the'}} {{od.ctx.isTeam ? 'team' : 'process'}}"+
              "${ if (!od.ctx.isItem) { }$"+
                " '{{od.story.team ? od.story.team.name || od.story.team.id :"+
      ...
      "invite:accept": {
        text: "{{od.ctx.amActor ? 'You' : od.story.actor.alias||od.story.actor.id}} "+
              "accepted "+
      ...
      "progress": {
        text: "{{od.ctx.amActor ? 'You' : od.story.actor.alias||od.story.actor.id}} completed "+
      ...
      "level": {
        text: "{{od.ctx.amActor ? 'Your' : (od.story.actor.alias||od.story.actor.id) + '\u2019s'}} "+
      ...
      "achievement": {
        text: "{{od.ctx.amActor ? 'Congratulations! You' : od.story.actor.alias||od.story.actor.id}}"+
